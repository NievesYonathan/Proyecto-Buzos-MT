		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a href="LP.html"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE
							PEDIDOS</a>
					</li>
					<li>
						<a class="active" href="PS.html"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR
							PEDIDO</a>
					</li>
				</ul>
			</div>
						...
						<div class="row justify-content-md-center">
							<div class="col-12 col-md-6">
								<div class="form-group">
									<label for="inputSearch" class="bmd-label-floating">¿Qué pedido estas
										buscando?</label>
