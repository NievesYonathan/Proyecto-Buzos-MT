		...
		<nav class="full-box nav-lateral-menu">
			<ul>
				...
				<li>
					...
					<ul>
						<li>
							<a href="../Informes/informes.php"><i class="fa-solid fa-industry"></i> &nbsp; Gestion de Producción</a>
						</li>
						<li>
							<a href="../Informes/info-produccion.php"><i class="fa-solid fa-user-tie"></i> &nbsp; Gestion</a>
						</li>
						<li>
							<a href="../Informes/info-Rec.Humanos.php"><i class="fa-solid fa-user-tie"></i> &nbsp; Gestion</a>
						</li>						
					</ul>
				</li>
