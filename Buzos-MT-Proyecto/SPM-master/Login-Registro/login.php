                ...
                background-color: #12464c; color: white; z-index: 9999;">
                    ...
                    <div class="form">
                        <form class="form" method="POST" action="../Controlador/ControladorUsuario.php">
                            ...
                            <div class="inputBox">
                                <?php
                                echo '<a class="submit-btn" href="' . $google_client->createAuthUrl() . '">Iniciar con Gmail</a>';
                                ?>
                            </div>
                            <p class="forget"><a href="registros.php">Registrarme</a></p>
                            <br>
                            <?php
                            $google_client->setPrompt('select_account');  // Añadir el prompt para forzar la selección de cuenta
                            $register_url = $google_client->createAuthUrl();
                            echo '<p class="forget"><a href="' . $register_url . '">Registrarme con Gmail</a></p>';
                            ?>
                            <br>
