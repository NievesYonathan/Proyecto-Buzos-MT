	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-sync-alt fa-fw"></i> &nbsp; ACTUALIZAR DATOS
				</h3>
							...
							<div class="row">
								<div class="col-12 col-md-2">
									<div class="form-group">
										<label for="usuario_dni" class="bmd-label-floating">T. Documento</label>
								...
								<div class="col-12 col-md-2">
									<div class="form-group">
										<label for="usuario_dni" class="bmd-label-floating">Num. Documento</label>
										<input type="text" pattern="[0-9-]{1,20}" class="form-control" name="usuario_dni" id="usuario_dni" maxlength="20">
									</div>
								</div>
