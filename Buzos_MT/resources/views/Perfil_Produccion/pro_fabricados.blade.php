                ...
                <div class="product-list mb-4 col-12">
                    <div class="product-item">
                        ...
                        <div class="product-info">
                            ...
                            <p class="product-dates">Fecha de Inicio: {{ $produccion->pro_fecha_inicio->format('Y-m-d') }}
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control border border-dark" name="produccion_nombre" id="produccion_nombre" maxlength="50" value="{{ $produccion->pro_nombre }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control border border-dark" name="produccion_fecha_inicio" id="productionDate" value="{{ $produccion->pro_fecha_inicio->format('Y-m-d') }}" disabled>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control border border-dark" name="produccion_fecha_fin" id="produccion_fecha_fin" value="{{ $produccion->pro_fecha_fin->format('Y-m-d') }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control border border-dark" name="produccion_cantidad" id="produccion_cantidad" maxlength="50" value="{{ $produccion->pro_cantidad }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control border border-dark" id="produccion_etapa" name="produccion_etapa" required>
                                                        <option value="{{ $produccion->etapa->id_etapas }}">{{ $produccion->etapa->eta_nombre }}</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <fieldset>
                                    ...
                                    <div class="container-fluid">
                                        <div class="row mt-3" id="mtPrima-container">
                                            @foreach ($produccion->materiaPrima as $registro)
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control border border-dark" id="produccion_mtPrima1" name="produccion_mtPrima[]" required>
                                                            <option value="{{ $registro->id_materia_prima }}">{{ $registro->mat_pri_nombre }}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control border border-dark" name="mtPrima_cantidad[]" id="mtPrima_cantidad1" maxlength="50" value="{{ $registro->pivot->reg_pmp_cantidad_usada }}" required>
                                                    </div>
                                                </div>
                                            @endforeach
                                        ...
                                        <div class="row" id="tarea-container">
                                            @foreach ($produccion->tareas as $tarea)
                                                <div class="col-12 col-md-4 mb-2">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control border border-dark" id="produccion_tarea1" name="produccion_tarea[]" required>
                                                            <option value="{{ $tarea->tarea_id_tarea }}">{{ $tarea->tar_nombre }}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-md-4 mb-2" id="resp-container">
                                                    <div class="form-group">
                                                        <select class="form-control border border-dark" id="produccion_responsable1" name="produccion_responsable[]" required>
                                                            <option value="{{ $tarea->pivot->empleados_num_doc }}">{{ $tarea->pivot->empleados_num_doc }}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-md-4 mb-2" id="fEntrega-container">
                                                    <div class="form-group">
                                                        <input type="date" class="form-control border border-dark" name="produccion_fecha_entrega[]" id="produccion_fecha_entrega1" value="{{ $tarea->pivot->emp_tar_fecha_entrega }}" required>
                                                    </div>
                                                </div>
                                            @endforeach
