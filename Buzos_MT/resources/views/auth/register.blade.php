...
=======
                <div  class="mt-4">
>>>>>>> origin/migracion-materia-prima
            ...
            <div class="col-sm-6">
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="num_doc" class="block mt-1 w-full" type="text" name="num_doc" required />
                </div>
            </div>
        </div>
...
<<<<<<< HEAD
            <div class="col-sm-6">
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="usu_telefono" class="block mt-1 w-full" type="text" name="usu_telefono" required />
                </div>
            </div>
            <div class="col-sm-6">
                <!-- Correo Electrónico -->
