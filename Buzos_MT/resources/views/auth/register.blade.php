    ...
    <script>
        document.getElementById('btnRegistrar').addEventListener('click', function (event) {
            ...
            if (!/^\d{10}$/.test(telefono)) {
                errores.push("El teléfono debe tener números y exactamente 10 dígitos.");
                document.getElementById('error-usu_telefono').innerText = "El teléfono debe tener números y exactamente 10 dígitos.";
            ...
            if (errores.length > 0) {
                // No envia el registroo si hay errores
            } else {
